...
This is a minimal Spring Boot 4 + Kotlin project demonstrating Spring Data Cassandra against **Apache Cassandra 6.0-alpha2**, with Flyway-managed schema migrations via the native (non-JDBC) Cassandra connector.
